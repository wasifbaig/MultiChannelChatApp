 ...
 setInterval(function(){
  ...
  function focusInput() {
    $(".chat-input input.text").focus();
        ...
        /* Speech to text*/
          document.getElementById('translator').onclick = function() {
            this.disabled = true;
            this.value = 'Speaking!';

            var lang = document.getElementById('convert-from').value.split(' (')[0];
            var translator = new Translator();
            var textareaFrom = document.getElementById('msgTextArea');
            translator.voiceToText(function(text) {
                textareaFrom.value = textareaFrom.value +' '+ text;
